...
```{r}
#Before we begin, we need to know the average change in math scores after one year (from year 0 to year 1) for all students:
mathchg <- mean(nyc_clean$y1_math_percentile)-mean(nyc_clean$y0_math_percentile)
```
